        ...
        <div class="d-md-flex justify-content-md-between">
            <div class="col-md-6 col-lg-5 order-md-2">
                <div class="contact-info d-flex flex-column justify-content-center">
                    <h4 class="contact-info-heading d-none d-md-block"><?php the_field('contact_info_heading'); ?></h4>
                    <p class="contact-info-content"><i class="material-icons">call</i> <?php the_field('contact_number'); ?></p>
                    <div class="border-line d-md-none"></div>
                    <p class="contact-info-content"><i class="material-icons">location_on</i> <?php the_field('contact_location'); ?></p>
                </div>
            </div>
